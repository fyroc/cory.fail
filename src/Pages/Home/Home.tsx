        ...
        <div className="py-8 flex items-stretch justify-center w-full">
            <div className="w-2/3 md:pr-5 md:pt-0">
                ...
                <div className="md:pt-16 pt-6">
                    <p className="md:text-6xl text-2xl font-bold md:leading-10 leading-6 text-theme-accent">Purpose and Usage</p>
                    <p className="md:text-xl text-base md:pt-8 pt-4 leading-normal text-theme-dark dark:text-theme-light hidden sm:block">Convallis turpis erat tempus, viverra aliquet. Nullam viverra nam auctor sit ipsum malesuada a, duis volutpat. Convallis turpis erat tempus, viverra aliquet. Nullam viverra nam auctor sit ipsum malesuada a, duis volutpat. </p>
                    <p className="md:text-xl text-base md:pt-8 pt-4 leading-normal text-theme-dark dark:text-theme-light sm:hidden">Convallis turpis erat tempus, viverra aliquet. Nullam viverra nam auctor sit ipsum malesuada. </p>
                </div>
            </div>
